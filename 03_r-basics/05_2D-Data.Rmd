...
1. [Matrices](#matrices) introduces matrices, data structures for storing 2d data that is all the same class.
2. [Dataframes](#dataframes) teaches you about the dataframe, the most important data structure for storing data in R, because it stores different kinds of (2d) data.

**********************************************************

## 1. Matrices <a name="#matrices"></a>
...
## 2. Dataframes <a name="#dataframes"></a>
...
```{r eval = FALSE}
# Assign names to basket
  names(basket) <- c(__________, ________)
# Check
  names(basket)
```
